...
cl = CYBERTK.LINE()
cl.login(token="ExjVkhH3l7UnuPQZvzf6.vMmGIvc5BZbL63lDtCVKXG.JBXyobsHVsNt7fBJxk1/2eORszFjOCwnxjqQ6/9JkiU=")
cl.loginResult()
...
admin=["u5663208950b96f3065eb72dd4dcbe4c6"]
creator=["u5663208950b96f3065eb72dd4dcbe4c6"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Davetlediğiniz için teşekkür ederim.
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u5663208950b96f3065eb72dd4dcbe4c6"}
...
➤https://line.me//ti/p/~farukyildiz61	
""")
#------------------------------------------------------------------
